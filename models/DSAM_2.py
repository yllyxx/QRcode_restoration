...
class DSAMBlock(nn.Module):
    ...
    def __init__(self, in_channel):
        ...
        self.cubic_11 = cubic_attention(in_channel // 2, group=1, kernel=7)
        self.cubic_7 = cubic_attention(in_channel // 2, group=1, kernel=5)
    ...
    def forward(self, x):
        ...
        out_11 = self.cubic_11(x[0])
        out_7 = self.cubic_7(x[1])
